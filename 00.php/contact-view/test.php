...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  $_SESSION['inquiryType'] = $_POST['inquiryType'] ?? '';
  $_SESSION['callbackPreference'] = $_POST['callbackPreference'] ?? '';
  ...
  // エラーがなければセッションに保存し、confirm.phpにリダイレクト
  if (empty($errors)) {
    $_SESSION['name'] = $name;
        ...
        <div class="container row">
          <form action="" method="post">
            ...
            <div class="form-group col-12 d-lg-flex ">
              ...
              <div class="d-lg-flex col-lg-9">
                <div class="form-check form-check-block align-items-center col-lg-4">
                  <input class="form-check-input" type="radio" name="inquiryType" id="corporate" value="corporate" <?php echo ($inquiryType === 'corporate') ? 'checked' : ''; ?> required>
                  <label class="form-check-label" for="corporate">法人のお客様</label>
                </div>
                <div class="form-check form-check-block align-items-center col-lg-4">
                  <input class="form-check-input" type="radio" name="inquiryType" id="individual" value="individual" <?php echo ($inquiryType === 'individual') ? 'checked' : ''; ?> required>
                  <label class="form-check-label" for="individual">個人のお客様</label>
                </div>
                <div class="form-check form-check-block align-items-center col-lg-4">
                  <input class="form-check-input" type="radio" name="inquiryType" id="other" value="other" required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <input type="text" name="name" class="form-control" id="name" placeholder="お名前を入力してください" required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <input type="text" name="companyName" class="form-control" id="companyName" placeholder="会社名を入力してください" value="<?php echo htmlspecialchars($companyName); ?>">
            </div>

            <!-- メールアドレス -->
            <div class="form-group d-lg-flex mt-3">
              <label for="email" class="col-lg-3 mb-2 me-5">メールアドレス <span class="badge text-bg-success">必須</span></label>
              <input type="email" name="email" class="form-control" id="email" placeholder="メールアドレスを入力してください" required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <input type="email" name="confirmEmail" class="form-control" id="confirmEmail" placeholder="確認用メールアドレスを入力してください" required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <textarea name="inquiry" class="form-control" id="inquiry" rows="4" placeholder="お問い合わせ内容を入力してください" required></textarea>
