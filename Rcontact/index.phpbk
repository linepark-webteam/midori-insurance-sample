...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // お問い合わせ内容
    if (strlen($inquiry) > 256) {
        $errors['inquiry'] = 'お問い合わせ内容は256文字以内で入力してください。';
    }
        ...
        <div class="container row">
          <form action="index.php" method="post">
            ...
            <div class="form-group col-12 d-lg-flex">
              ...
              <div class="d-lg-flex col-lg-9">
                <div class="form-check form-check-block align-items-center col-lg-4">
                  <input class="form-check-input" type="radio" name="inquiryType" id="corporate" value="法人のお客様" <?php echo ($inquiryType === 'corporate') ? 'checked' : ''; ?> required>
                  <label class="form-check-label" for="corporate">法人のお客様</label>
                </div>
                <div class="form-check form-check-block align-items-center col-lg-4">
                  <input class="form-check-input" type="radio" name="inquiryType" id="individual" value="個人のお客様" <?php echo ($inquiryType === 'individual') ? 'checked' : ''; ?> required>
                  <label class="form-check-label" for="individual">個人のお客様</label>
                </div>
                <div class="form-check form-check-block align-items-center col-lg-4">
                  <input class="form-check-input" type="radio" name="inquiryType" id="other" value="other" <?php echo ($inquiryType === 'other') ? 'checked' : ''; ?> required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <input type="text" name="name" class="form-control d-block" id="name" placeholder="お名前を入力してください" maxlength="32" value="<?php echo htmlspecialchars($name); ?>" required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <div class="d-flex flex-column col-lg-8">
              <input type="email" name="email" class="form-control d-block" id="email" placeholder="メールアドレスを入力してください" maxlength="64" value="<?php echo htmlspecialchars($email); ?>" required>
              <?php if (!empty($errors['email'])) : ?>
                <div class="error text-danger col-lg-9"><?php echo $errors['email']; ?></div>
              <?php endif; ?>
            </div>
            </div>
            ...
            <!-- 確認用メールアドレス -->
              <div class="form-group d-lg-flex mt-3">
                <label for="confirmEmail" class="col-lg-3 mb-2 me-5">確認用メールアドレス <span class="badge text-bg-success">必須</span></label>
                <div class="d-flex flex-column col-lg-8">
                <input type="email" name="confirmEmail" class="form-control d-block" id="confirmEmail" placeholder="確認用メールアドレスを入力してください" maxlength="64" value="<?php echo htmlspecialchars($confirmEmail); ?>" required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <div>
                <div class="form-check align-items-center form-check-block">
                  <input class="form-check-input" type="radio" name="callbackPreference" id="contactByEmail" value="email" <?php echo ($callbackPreference === 'email') ? 'checked' : ''; ?> required>
                  <label class="form-check-label" for="contactByEmail">メールでの連絡希望</label>
                </div>
                <div class="form-check align-items-center form-check-block">
                  <input class="form-check-input" type="radio" name="callbackPreference" id="contactByPhone" value="phone" <?php echo ($callbackPreference === 'phone') ? 'checked' : ''; ?> required>
            ...
            <div class="form-group d-lg-flex mt-3">
              ...
              <div class="d-flex flex-column col-lg-8">
              <textarea name="inquiry" class="form-control" id="inquiry" rows="4" placeholder="お問い合わせ内容を入力してください" required><?php echo htmlspecialchars($inquiry); ?></textarea>
            ...
            <div class="form-group my-5">
              <div class="form-check d-flex justify-content-center">
                <input type="checkbox" name="privacyPolicy" class="form-check-input" id="privacyPolicy" required>
